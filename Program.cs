...
namespace oo_csharp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            tigre = new Animal("felino", "tigre", "laranja");
            tigre.SetPerigoso(true);

            string teste = tigre.Especie;
            Console.WriteLine("Somente especie: " + tigre.Especie);

            string descricao = tigre.Descrever();
            Console.WriteLine(descricao);

            Console.WriteLine("Fazendo barulho: " + tigre.FazerBarulho() );

            Console.WriteLine(tigre.QuantidadePatas);
            tigre.QuantidadePatas = 8;
            Console.WriteLine(tigre.QuantidadePatas);
